...
const components: PortableTextComponents = {
  ...
  block: {
    ...
    h2: ({ children }) => (
      <h2 className="mt-12 mb-4 font-display text-2xl tracking-tight text-white first:mt-0 sm:text-3xl">
        {children}
      </h2>
    ),
    h3: ({ children }) => (
      <h3 className="mt-10 mb-3 font-display text-xl tracking-tight text-white first:mt-0 sm:text-2xl">
        {children}
      </h3>
    ),
    h4: ({ children }) => (
