...
const catalog: TechDefinition[] = [
  ...
  { display: "NumPy", aliases: ["numpy"], icon: Braces },
  { display: "OpenCV", aliases: ["opencv"], icon: Scan },
  { display: "Vector Database", aliases: ["vector database", "vectordb", "vector db"], icon: Database },
  { display: "Image Recognition", aliases: ["image recognition", "computer vision"], icon: Scan },
  { display: "Pinecone", aliases: ["pinecone"], icon: Database },
  { display: "Weaviate", aliases: ["weaviate"], icon: Database },
  { display: "PyTorch", aliases: ["pytorch"], icon: Cpu },
  { display: "TensorFlow", aliases: ["tensorflow"], icon: Cpu },
  { display: "Pandas", aliases: ["pandas"], icon: Table2 },
  { display: "scikit-learn", aliases: ["scikit-learn", "sklearn", "scikitlearn"], icon: Sparkles },
